...
static char *test_getNth() {
    ...
    qsort(v, size, sizeof(int), cmp);
    sd_assert("getNth - Test 1 picat", getNth(l, 0) == v[0] && getNth(l, size-1) == v[size-1]);
    if(l != NULL) {
        l = freeTSortedList(l);
    }
    free(v);
    ...
    qsort(v, size, sizeof(int), cmp);
    sd_assert("getNth - Test 2 picat", getNth(l, 2) == v[2] && getNth(l, size - 2) == v[size-2]);
    if(l != NULL) {
        l = freeTSortedList(l);
    }
    free(v);
    ...
    qsort(v, size, sizeof(int), cmp);
    sd_assert("getNth - Test 3 picat", getNth(l, 5) == v[5] && getNth(l, size-10) == v[size-10]);
    if(l != NULL) {
        l = freeTSortedList(l);
    }
    free(v);
